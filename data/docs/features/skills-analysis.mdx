...
description: "Extract, analyze, and verify skills from profiles and job postings with SJM's advanced AI analysis"
---
...
SJM's Skills Analysis module uses advanced AI-driven natural language processing to identify technical and soft skills from unstructured text. The system can:
...
This functionality forms the foundation of SJM's matching capabilities, enabling precise alignment between candidates and opportunities.
...
<CodeTabs tabs={{
  "Node.js": `
const { SkillsExtract } = require('sjm');
...
curl -X POST https://api.sjm.ai/v1/verify-skill \\
...
curl -X POST https://api.sjm.ai/v1/extract-skills \\
-H "X-API-Key: YOUR_API_KEY" \\
-H "Content-Type: application/json" \\
-d '{
"text": "Experienced software engineer with 5 years of React.js, Node.js, and TypeScript. Familiar with AWS and Docker containerization."
...
<FeaturedExample
  ...
  code={`
// Node.js example
const { ResumeParser } = require('sjm');
...
<CodeTabs tabs={{
  "Node.js": `
const { SkillGapAnalyzer } = require('sjm');
...
`,
  "Python": `
from sjm import SkillGapAnalyzer
...
## Integration with Other SJM Features
